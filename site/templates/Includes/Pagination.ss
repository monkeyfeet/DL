...
<% if MoreThanOnePage %>
    <div class="pagination center clear">
    
        <% if NotFirstPage %>
            <a class="prev button red readmore" href="$PrevLink" title="View the previous page">Prev</a>
        <% else %>	
        ...
        <% if NotLastPage %>
            <a class="next button red readmore" href="$NextLink" title="View the next page">Next</a>
        <% else %>	
